...
(function (L11_Asteroids) {
    ...
    function createPaths() {
        L11_Asteroids.asteroidPaths = createAsteroidPaths(L11_Asteroids.shapesAsteroids);
        L11_Asteroids.ufoPath = createUfoPath();
    }
    L11_Asteroids.createPaths = createPaths;
