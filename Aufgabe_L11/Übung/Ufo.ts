namespace L11_Asteroids {
    ...
    private shoot(): void {
        ...
        let event: CustomEvent = new CustomEvent(ASTEROID_EVENT.UFO_SHOOTS, {detail: {ufo: this}}); // {}Object --> Schüssel "details", kann man selbst bennen (ufo) this verweist auf das ufo 
